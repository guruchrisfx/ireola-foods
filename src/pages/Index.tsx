    ...
    <div>
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="container relative py-20 md:py-32 text-center">
          <h1 className="font-display text-3xl md:text-5xl lg:text-6xl font-bold text-primary-foreground mb-4 leading-tight">
            Quality Cereals & Beverages<br />in Measured Quantities
          </h1>
      ...
      <section className="bg-primary text-primary-foreground py-4">
        <div className="container flex flex-wrap justify-center gap-6 md:gap-12 text-sm font-medium">
          ...
          <span className="flex items-center gap-2"><Star className="h-4 w-4" /> Trusted by Families</span>
        </div>
      </section>

      {/* Categories */}
      <section className="container py-12 md:py-20">
        <h2 className="font-display text-2xl md:text-3xl font-bold text-center mb-8">Shop by Category</h2>
      ...
      {/* How It Works */}
      <section className="container py-12 md:py-20">
        <h2 className="font-display text-2xl md:text-3xl font-bold text-center mb-10">How Ordering Works</h2>
      ...
      <section className="bg-cream py-12 text-center">
        <div className="container">
          ...
          <p className="text-muted-foreground mb-6">See our latest products and deals @ireola_foods_cereals_vendor</p>
          <Button variant="outline" size="lg" asChild>
            <a href="https://instagram.com/ireola_foods_cereals_vendor" target="_blank" rel="noopener noreferrer">
              Follow @ireola_foods_cereals_vendor
            </a>
          </Button>
        </div>
      </section>
