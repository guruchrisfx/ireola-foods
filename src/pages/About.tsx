  ...
  <div>
    <section className="bg-primary text-primary-foreground py-12 md:py-24">
      <div className="container text-center px-4">
        <img src={logo} alt="Ireola Foods" className="h-18 w-18 md:h-24 md:w-24 rounded-full mx-auto mb-4 md:mb-6 object-cover border-4 border-primary-foreground/20" />
        <h1 className="font-display text-2xl md:text-5xl font-bold mb-3 md:mb-4">About Ireola Foods</h1>
    ...
    <section className="container py-8 md:py-20 max-w-3xl px-4">
      <h2 className="font-display text-xl md:text-2xl font-bold mb-3 md:mb-4">Our Story</h2>
    ...
    <section className="bg-cream py-8 md:py-16">
      <div className="container grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-8 text-center px-4">
        {[
          ...
          <div key={i}>
            <item.icon className="h-6 w-6 md:h-8 md:w-8 mx-auto mb-1.5 md:mb-2 text-primary" />
